...
class Neighborhood(django_models.Model):
    ...
    city = django_models.ForeignKey(City,
                                    verbose_name=_("City"),
...
def import_from_external_source(external_address: dict) -> Neighborhood:
    ...
    neighborhood_data = {'city': city, 'description': external_address.get('neighborhood_name')}
    neighborhood, create = Neighborhood.objects.get_or_create(**neighborhood_data, defaults=neighborhood_data)
