...
router.register(r'helprequeststatus', views.HelpRequestStatusView, basename='helprequeststatus')
...
router.register(r'helprequestcancelreason', views.HelpRequestCancelReasonView, basename='helprequestcancelreason')
